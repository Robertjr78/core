...
contract Auction is ReentrancyGuard, Ownable, Pausable, IERC721Receiver {
    ...
    bool public feeRewardBBIsEnabled = true;
    ...
    constructor(
        ...
        ISwapFeeRewardWithBB feeRewardBB_
    ) {
    ...
    function _collect(uint256 id) internal {
        ...
        if (fee > 0) {
            ...
            if (
                feeRewardBBIsEnabled && nftForAccrualBB[address(inv.pair.nft)]
            ) {
                feeRewardBB.accrueBBFromAuction(
                    inv.bidder,
